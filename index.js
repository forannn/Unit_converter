document.getElementById("convert").addEventListener("click", function() {
    ...
    document.getElementById("render3").textContent = `${number.value} kilos = ${(number.value * 2.204).toFixed(3)} pounds | ${number.value} pounds = ${(0.453 * number.value).toFixed(3)} kilos`
